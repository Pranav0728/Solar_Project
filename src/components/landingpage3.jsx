   ...
   useEffect(() => {
    ...
    return (
      ...
      <div className=" w-[100%] h-[100vh]  p-11 page3 pt-0 ">
          <div className="inpage3 w-[100%] h-[100%] hidden1 flex   rounded-2xl relative overflow-hidden p-8 pl-14 pt-[5%] bg-white">
             ...
             <div className="h-[9vw] w-[9vw] hidden2 top-10 right-10  border-[2px] border-[rgba(255,255,255,1)] absolute  rounded-full items-center flex flex-col justify-center ">
