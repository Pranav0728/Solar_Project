...
export default function Landingpage6() {
  ...
  return (
    ...
    <>
    <div className=" w-[100%] page6 p-11 pt-0 pb-0">
        <div className="w-[100%] h-[100%] inp6 md:gap-[50px]  p-11 md:pl-15 bg-white flex flex-col  rounded-2xl relative overflow-hidden  ">
          <h2>WHAT WE PROVIDE </h2>
          <hr></hr>
          <div className="w-[100%] flex justify-between items-center p7map">
            <h5>01</h5>
          ...
          {provide.map((provide, index) => (
           ...
           <div className="h-[9vw] w-[9vw]  border-[1px] border-[rgba(0,0,0,0.7)] p5button self-center rounded-full items-center flex flex-col justify-center ">
